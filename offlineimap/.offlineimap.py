...
"""
Return password for mail account using password manager
"""
import subprocess

def get_password(account):
    params = {
        'pass_manager': '/usr/bin/pass',
        'account': 'mail/' + account,
    }
    command = "%(pass_manager)s %(account)s" % params
...
"""
Make get_password() the default function via calling this file directly
"""
import sys
